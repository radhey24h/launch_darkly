...
public sealed class DotNetMiddlewareClient : IDotNetClient
{
    private const string ClientName = "DotNetMiddleware";
    private readonly IHttpClientFactory _httpClientFactory;
    private readonly ILogger<DotNetMiddlewareClient> _logger;

    public DotNetMiddlewareClient(IHttpClientFactory httpClientFactory, ILogger<DotNetMiddlewareClient> logger)
    {
        ...
        ProcessRequest request, CancellationToken cancellationToken = default)
    {
        ...
        _logger.LogInformation(
            "DotNetMiddleware responded: StatusCode={StatusCode} TransactionId={TransactionId} CorrelationId={CorrelationId}",
